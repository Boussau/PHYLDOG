...
#CC = mpic++ -fopenmp -m64 -O3 -I $(BOOST_INCLUDE)
...
SpeciesTreeLikelihood.o : $(SRC)SpeciesTreeLikelihood.cpp $(SRC)SpeciesTreeLikelihood.h $(SRC)SpeciesTreeExploration.h $(SRC)ReconciliationTools.h $(SRC)COALTools.h
	$(CC) $(INCLUDE) -c $(SRC)SpeciesTreeLikelihood.cpp $(SRC)SpeciesTreeLikelihood.h $(SRC)SpeciesTreeExploration.h $(SRC)ReconciliationTools.h $(SRC)COALTools.h

COALGeneTreeLikelihood.o : $(SRC)COALGeneTreeLikelihood.cpp $(SRC)COALGeneTreeLikelihood.h COALTools.o GeneTreeLikelihood.o ReconciliationTools.o $(SRC)GenericTreeExplorationAlgorithms.h $(SRC)FastRHomogeneousTreeLikelihood.o
	$(CC) $(INCLUDE) -c $(SRC)COALGeneTreeLikelihood.cpp $(SRC)COALGeneTreeLikelihood.h $(SRC)GeneTreeLikelihood.h $(SRC)COALTools.h $(SRC)ReconciliationTools.h $(SRC)FastRHomogeneousTreeLikelihood.h

DLGeneTreeLikelihood.o : $(SRC)DLGeneTreeLikelihood.cpp $(SRC)DLGeneTreeLikelihood.h GeneTreeLikelihood.o ReconciliationTools.o $(SRC)GenericTreeExplorationAlgorithms.h $(SRC)FastRHomogeneousTreeLikelihood.o
	$(CC) $(INCLUDE) -c $(SRC)DLGeneTreeLikelihood.cpp $(SRC)DLGeneTreeLikelihood.h $(SRC)GeneTreeLikelihood.h $(SRC)ReconciliationTools.h $(SRC)GenericTreeExplorationAlgorithms.h $(SRC)FastRHomogeneousTreeLikelihood.h

GeneTreeLikelihood.o : $(SRC)GeneTreeLikelihood.cpp $(SRC)GeneTreeLikelihood.h ReconciliationTools.o
	$(CC) $(INCLUDE) -c $(SRC)GeneTreeLikelihood.cpp $(SRC)GeneTreeLikelihood.h $(SRC)ReconciliationTools.h 

COALTools.o : $(SRC)COALTools.cpp $(SRC)COALTools.h ReconciliationTools.o
	$(CC) $(INCLUDE) -c $(SRC)COALTools.cpp $(SRC)COALTools.h $(SRC)ReconciliationTools.h 
